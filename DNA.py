...
class Compression:
    ...
    def compress_file(self, input_file):
        ...
        with open(nameas, "wb") as f4:
            f4.write(b'')

        with open(nameas, "ab") as f3:
            f3.write(b'')
    ...
    def extract_and_reverse_compression(self, compressed_data):
        sda2 = ""
        sda4 = ""
        cvf1 = 0
        ...
        for bit in sda2:
            ...
            if len(sda10) == 15:
                e10 = sda10[14]
                sda10 = sda10[:14]
            if e10 == "0" and len(sda10) == 8:
                sda4 += sda10
                sda10 = ""
                e10 = ""
                start = 1
            elif e10 == "1" and len(sda10) == 8:
                sda4 += sda10
                sda10 = ""
                e10 = ""
                start = 1
        ...
        # Now, sda4 contains the reversed uncompressed data
...
def main():
    ...
    if compression.namez == 'c':
        compression.compress_file(input_file)
        print("Compression finished.")
    elif compression.namez == 'e':
        compressed_data = open(input_file + ".bin", 'rb').read()
